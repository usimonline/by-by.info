...
switch ($text_dip_case) {
    case 1:
        ...
        10 научных статей, принимал участие в научных конференциях. Аналитический склад ума.
        ';
        break;
    case 2:
...
switch ($text_mag_case) {
    case 1:
        $text_mag = 'Более трех лет работал аналитиком СМИ, web-программистом, копирайтером, корректором и редактором на фрилансе.
...
switch ($vibor_filial_case) {
    case 1:
        ...
        В социальных сетях размещал анонсы с помощью сервиса seolit.ru. 
        Занимался email-рассылками посредством сервиса sendpulse.com.';
        break;
    case 2:
