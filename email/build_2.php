...
switch ($per_site){
    case 1: $site_name = $site_name;
        break;
    case 2: $site_name = $site_name;
        break;
    case 3: $site_name = $site_name;
        break;
    case 4: $site_name = $site_name;
        break;
    case 5: $site_name = $site_name;
        break;
    case 6: $site_name = $site_name;
        break;
...
switch ($vibor_let_case) {
    case 1:
        $vibor_let = 'Занимаюсь редакторской работой три года.';
        break;
    case 2:
...
switch ($vibor_pris_case) {
 ...
 и развития профессиональных навыков
         ...
         Недавно начал вести блог, рекомендую мое <a href="https://www.youtube.com/watch?v=1XtWGiAqZyU">ВидеоРезюме</a>. 
         ';
        break;
...
switch ($text_dip_case) {
    case 1:
        ...
        10 научных статей, работал в БГУ и БНТУ преподавателем. Аналитический склад ума.
        ';
        break;
    case 2:
...
switch ($text_mag_case) {
    case 1:
        $text_mag = 'Более двух лет работал аналитиком СМИ, web-программистом, копирайтером, корректором и редактором на фрилансе.
...
switch ($vibor_filial_case) {
    case 1:
        $vibor_filial = 'Для сайтов программировал на php + css + html, 
        создавал семантическое ядро, писал статьи по ТЗ. Картинки в Photoshop. 
        В социальных сетях размещал анонсы (seolit.ru), 
        занимался email-рассылками.';
        break;
    case 2:
            ...
            <table width="'.$rand_nom_text_1.'" border="0" cellpadding="0" cellspacing="0" class="force2_row2'.$style_1.'" style="width: '.$rand_nom_text_1.'px;">
              ...
              <tr>
                ...
                <td class="con3tent'.$style_1.'w43rapper" style="padding-left: '.$rand_nom_text_10.'; padding-right: '.$rand_nom_text_10.'">
                  ...
                  <a href="mailto:'.$email.'" >'.$rand_nom_text_4.'</a>
