...
function autor_rand($string)// заменяет последнее вхождение подстроки
{
	$first=array('Ольга Усим','Анастасия Булгакова','Алексей Машеров','Алесь Карпович','Олег Бондарев','Алена Монахова',
		'Нина Тимошенко','Татьяна Клышникова','Сергей Станочник','Андрей Руманович','Сергей Станочник','Георгий Найденов',
