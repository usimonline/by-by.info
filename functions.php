...
$lat=array('bestmemes','helpstud','caricatures','belnews','coldwar','polithumor','belarus','russia','ancientukri','poland','west','ussr','cis','economy','policy','syria','novoros','baltic','world','interview','army','rusbel','history','religion','science','language','agents','nweapon','CSTO','site','eaes','SovetskijSojuz');
	$string = str_replace($lat, $rus, $string);
	return $string;
}
...
function transform_img($string,$url,$pic_alt) {
	$first=array('bestmemes','helpstud','caricatures','belnews','coldwar','polithumor','ancientukri','economy','history','agents','eaes','SovetskijSojuz');
...
function transform_img_prost($string) {
	$first=array('/bestmemes/','/helpstud/','/caricatures/','/belnews/','/coldwar/','/polithumor/','/ancientukri/','/economy/','/history/','/agents/','/eaes/','/SovetskijSojuz/');//eaes добавить
