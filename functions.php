...
function transform_img($string,$url,$pic_alt) {
	...
	if (!empty($pic_alt[6])) $string = str_replace("<img_6img>", $first.'5'.$second.$pic_alt[6].$third.$pic_alt[6].$fourth, $string);
	if (!empty($pic_alt[7])) $string = str_replace("<img_7img>", $first.'5'.$second.$pic_alt[7].$third.$pic_alt[7].$fourth, $string);
	if (!empty($pic_alt[8])) $string = str_replace("<img_8img>", $first.'5'.$second.$pic_alt[8].$third.$pic_alt[8].$fourth, $string);
	if (!empty($pic_alt[9])) $string = str_replace("<img_9img>", $first.'5'.$second.$pic_alt[9].$third.$pic_alt[9].$fourth, $string);
	if (!empty($pic_alt[10])) $string = str_replace("<img_10img>", $first.'5'.$second.$pic_alt[10].$third.$pic_alt[10].$fourth, $string);
