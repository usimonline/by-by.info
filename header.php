...
<!-- /Yandex.Metrika counter -->
	...
	<header class="header">
		...
		<div class="header__main">
		 ...
		 name='searchnews' value='Введите слово'  />
				...
				<a class="header__top-item send-news" href="<?php echo $main_name; ?>/news/2018/04/05/1522951650/prislat-novost/" rel="nofollow">Прислать новость</a>
	...
	<div class="footer__topics">
		<ul>
			<li><a href="<?php echo $main_name; ?>/belnews/" rel="nofollow">НОВОСТИ БЕЛАРУСИ</a></li>
			<li><a href="<?php echo $main_name; ?>/coldwar/" rel="nofollow">ХОЛОДНАЯ ВОЙНА</a></li>
			<li><a href="<?php echo $main_name; ?>/polithumor/" rel="nofollow">ПОЛИТИЧЕСКИЙ ЮМОР</a></li>
			...
			<li><a href="<?php echo $main_name; ?>/history/" rel="nofollow">История</a></li>
