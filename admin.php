...
$res = mysqli_query($link, $select);
	...
	$keys = 'История, Новости Беларуси, Холодная война, Политический юмор, Мемы, Евразийский союз, Карикатуры, Украина, экономика, Агенты запада, Советский союз';
...
<textarea style="width:200px; height:30px; border: 1px solid #cccccc;" 
	...
	<p>history belnews coldwar polithumor bestmemes caricatures ancientukri economy agents eaes SovetskijSojuz</p><br>
