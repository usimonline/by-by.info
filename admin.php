...
$res = mysqli_query($link, $select);
	...
	$razdel = '';
	$text = 'Текст';
	$keys = 'НОВОСТИ БЕЛАРУСИ, ХОЛОДНАЯ ВОЙНА, ПОЛИТИЧЕСКИЙ ЮМОР, БЕЛОРУССИЯ, РОССИЯ, УКРАИНА, ПОЛЬША, ЗАПАД, СОВЕТСКИЙ СОЮЗ, СНГ, ЭКОНОМИКА, ПОЛИТИКА, СИРИЯ, НОВОРОССИЯ, 
	ПРИБАЛТИКА, МИР, АРМИЯ,СОЮЗНОЕ ГОСУДАРСТВО РОССИИ И БЕЛОРУССИИ, ИСТОРИЯ, РЕЛИГИЯ, 
