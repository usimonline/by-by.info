...
$text_temp_2 = $_POST['description_'.$k];//file_get_contents($url_mass_url[$i]);
...
$url_mass_texts[$i] = strip_tags(str_replace('ВЗГЛЯД', 'by-by.info', $text_temp_2),'<b><p><img><frame><figure><figcaption><h1><h2><h3><strong><table><tbody><tr><td>');
                        //$url_mass_texts[$i] = str_replace('vz.ru', 'by-by.info', $text_temp_2);




                        $contentTitle = str_replace('vz.ru', 'by-by.info',$_POST['title_'.$k]);
                     ...
                     //  $contentTitle = str_replace('vz.ru', 'by-by.info',$contentTitle);
                      //  $contentTitle = str_replace('FINANCE.', '',$contentTitle);
                        $url_mass_description[$i] = $contentTitle; //strip_tags($contentTitle, '<p>');
