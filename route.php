...
switch($REQUEST_URI ){
	...
	case '/belnews/': $REQUEST_URI = '/pastnews/belnews/50/';
		$title_rub = 'Новости Беларуси без русофобии про белорусизацию и ЕАЭС';
		$description_rub = 'Портал ' . $site_name . ' публикует новости Беларуси, очищенные от русофобии белорусских националистов, специально 
		для друзей России. Только самые важные сведения про русский язык, белорусизацию, Лукашенко и ЕАЭС, читайте страницы ' ;
	...
	case '/coldwar/': $REQUEST_URI = '/pastnews/coldwar/50/';
		...
		$description_rub = 'Портал ' . $site_name . ' публикует новости холодной войны России и Запада. Наши журналисты пишут про 
	...
	case '/polithumor/': $REQUEST_URI = '/pastnews/polithumor/50/';
		$title_rub = 'Политический юмор об Украине и России';
		$description_rub = 'Портал ' . $site_name . ' публикует новости политического юмора: приколы про Порошенко, анекдоты про Украину. 
	...
	case '/bestmemes/': $REQUEST_URI = '/pastnews/bestmemes/50/';
		...
		$description_rub = 'Портал ' . $site_name . ' публикует новости мемов: мемы о России, мемы об Украине. 
		Наши авторы сами придумывают самые смешные мемы, а также находят лучшие мемы в интернете, читайте страницы ';
		$keys_rub = 'Мемы, мемы об Украине, мемы о России';
	...
	case '/ancientukri/': $REQUEST_URI = '/pastnews/ancientukri/50/';
		...
		$description_rub = 'Портал ' . $site_name . ' публикует новости Украины, очищенные от русофобии украинских националистов, специально 
		для друзей России. Только самые важные сведения про русский язык, украинский фашизм, вступление Украины в ЕС и НАТО, читайте страницы ' ;
	...
	case '/economy/': $REQUEST_URI = '/pastnews/economy/50/';
		$title_rub = 'Новости экономики Беларуси и ЕАЭС';
		$description_rub = 'Портал ' . $site_name . ' публикует новости экономики Беларуси и ЕАЭС. Наши журналисты пишут про 
		состояние экономики Беларуси, об экономике Союзного государства Беларуси и России, экономике ЕАЭС, читайте страницы ';
		$keys_rub = 'экономика Беларуси, экономика ЕАЭС, экономика синеокой';
		$url_og_rub = '/economy/';
		$url_og_picture_rub = "/img/metro.jpg";
		break;
	case '/agents/': $REQUEST_URI = '/pastnews/agents/50/';
		$title_rub = 'Анализ деятельности западных агентов в Беларуси и России';
		$description_rub = 'Портал ' . $site_name . ' публикует анализ деятельности западных агентов в Беларуси и России. Наши журналисты пишут про 
		влияние западных сетевых структур на общество Беларуси и России, про оранжевые революции и информационные войны, читайте страницы ';
