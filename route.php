...
switch($REQUEST_URI ){
	case '/splitmind/': $REQUEST_URI = '/pastnews/splitmind/50/';
		$title_rub = 'Шизофрения';
		$description_rub = 'Шизофрения для страдающих и их родствеников, страницы ';
		$keys_rub = 'Шизофрения';
	...
	case '/polithumor/': $REQUEST_URI = '/pastnews/polithumor/50/';
		...
		$description_rub = 'Политический юмор, свежие мемы и карикатуры, страницы ';
	...
	case '/economy/': $REQUEST_URI = '/pastnews/economy/50/';
		$title_rub = 'Экономика';
		$description_rub = 'Ээкономика Запада, России, Белорусии и ЕАЭС, страницы ';
		$keys_rub = 'Экономика';
		$url_og_rub = '/economy/';
		$url_og_picture_rub = "/img/metro.jpg";
		break;
	case '/agents/': $REQUEST_URI = '/pastnews/agents/50/';
		$title_rub = 'Агенты влияния';
		$description_rub = 'Портреты агентов западного влияния в России и мире, страницы ';
		$keys_rub = 'Агенты Запада';
		$url_og_rub = '/agents/';
		$url_og_picture_rub = "/img/metro.jpg";
		break;
	case '/eaes/': $REQUEST_URI = '/pastnews/eaes/50/';
		$title_rub = 'Евразийский Союз';
		$description_rub = 'Новости развития Евразийского Экономического Союза (ЕАЭС), страницы ';
		$keys_rub = 'Евразийский Союз';
		$url_og_rub = '/eaes/';
		$url_og_picture_rub = "/img/metro.jpg";
		break;
	case '/SovetskijSojuz/': $REQUEST_URI = '/pastnews/SovetskijSojuz/50/';
		$title_rub = 'Советский союз';
		$description_rub = 'История СССР, достижения советского народа и победа в Великой Отечественной войне, страницы ';
