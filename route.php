...
switch($REQUEST_URI ){
	...
	case '/centralnews/': $REQUEST_URI = '/topic/toplist/50/';
		...
		$url_og_picture_rub = "/img/metro.jpg";
		break;
	case '/headernews/': $REQUEST_URI = '/topic/header/50/';
		$title_rub = 'Анлитические статьи, политические тренды и прогнозы';
		$description_rub = 'Аналитика политической жизни России и мира. 50 свежих новостей.';
		$keys_rub = 'Анлитические статьи';
		$url_og_rub = '/headernews/';
		$url_og_picture_rub = "/img/metro.jpg";
		break;
	case '/topweek/': $REQUEST_URI = '/topic/topnews/50/';
		$title_rub = 'Событие недели России и мира по мнению нашей редакции';
		$description_rub = 'Наши редакторы составили список основных событий России и мира. 50 свежих новостей.';
		$keys_rub = 'События недели';
		$url_og_rub = '/topweek/';
		$url_og_picture_rub = "/img/metro.jpg";
		break;
