...
switch($REQUEST_URI ){
	...
	case '/polithumor/': $REQUEST_URI = '/pastnews/polithumor/50/';
		$title_rub = 'Политический юмор про Порошенко и Украину, карикатуры и мемы';
		$description_rub = 'Портал ' . $site_name . ' публикует новости политического юмора: приколы про Порошенко, анекдоты про Украину и карикатуры. 
		Наши авторы сами придумывают самые смешные истории, а также находят лучшие мемы и демотиваторы в интернете, читайте страницы ';
		$keys_rub = 'Политический юмор, анекдоты про Украину, приколы про Порошенко';
...
if ($route){
	switch($REQUEST_URI){
		...
		default:
			...
			$rubrika_2_array = Array('empty', 'bestmemes','helpstud','caricatures','belnews','coldwar','polithumor','belarus','russia','ancientukri','poland','west','ussr','cis','economy','policy','syria','novoros','baltic','world','interview','army','rusbel','history','religion','science','language','agents','nweapon','CSTO','site');
