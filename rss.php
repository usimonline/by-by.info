        ...
        for($i = 0; $i < $total; $i++) {
           ...
           // $n_l_u_pict = str_replace('news','pictures',$url_pic_news_latest).'img_1.jpg';
            ...
            if ($colichestvo_h2_per > 1){
                ...
                for($j = 0; $j < $colichestvo_h2_per; $j++){
                    $soderg_123 = $soderg_123.'<li><a href="#my_page_'.$j.'">'.($j+1).'. '.$massiv_h2[$j].'</a></li>';
                }
...
<item turbo="true">
            ...
            <author>Главный редактор Ольга Усим</author>
            <yandex:related>
    ...
    <!-- Контентная часть -->
    '.$autor_123.$soderg_123.$text_123.$url_frame_123.'
                ]]>
            </turbo:content>
        </item>';
            }
